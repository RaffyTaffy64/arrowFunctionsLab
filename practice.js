...
// Have it take 2 parameters, an array and a call back
// Invoke the callback function, bringing in the first element of the array as its argument
...
const last = (arr, callback) => callback(arr.slice(-1).pop())
